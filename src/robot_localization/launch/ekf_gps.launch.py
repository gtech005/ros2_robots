...
def generate_launch_description():
  ...
  pkg_share_urdf = FindPackageShare(package='rovers_descriptions').find('rovers_descriptions')

  default_launch_dir = os.path.join(pkg_share, 'launch')
  default_model_path = os.path.join(pkg_share_urdf, 'urdf/cyclairbot_castorv1.xacro')
  robot_localization_file_path = os.path.join(pkg_share, 'params/ekf_gps.yaml') 
  robot_name_in_urdf = 'cyclairbot_castorv1'
  world_file_name = 'basic_mobile_bot_world/smalltown.world'
  world_path = os.path.join(pkg_share_urdf, 'worlds', world_file_name)
  ...
  start_navsat_transform_cmd = Node(
    ...
    remappings=[('imu', 'main_imu_plugin/out'),
                ('gps/fix', 'gps_center/fix'), 
